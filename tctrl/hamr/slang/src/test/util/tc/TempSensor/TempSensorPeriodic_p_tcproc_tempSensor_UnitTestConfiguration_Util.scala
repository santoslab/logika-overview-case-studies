...
object TempSensorPeriodic_p_tcproc_tempSensor_UnitTestConfiguration_Util {
...
@record class TempSensorPeriodic_p_tcproc_tempSensor_Initialize_UnitTestConfiguration (
  var verbose: B,
  var name: String,
...
@record class TempSensorPeriodic_p_tcproc_tempSensor_Compute_UnitTestConfiguration (
  var verbose: B,
  var name: String,
  var description: String,
  var numTests: Z,
  ...
  override def test(c: Container): GumboXResult.Type = {
    return testComputeCBV(c.asInstanceOf[TempSensorPeriodic_p_tcproc_tempSensor_PreState_Container_P])
  }
}
