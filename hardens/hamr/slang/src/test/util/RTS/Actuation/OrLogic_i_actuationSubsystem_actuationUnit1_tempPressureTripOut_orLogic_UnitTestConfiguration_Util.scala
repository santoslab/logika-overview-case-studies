...
object OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_UnitTestConfiguration_Util {

  def freshRandomLib: RandomLib = {
    return RandomLib(Random.Gen64Impl(Xoshiro256.create))
  }

  def defaultComputeConfig: OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Compute_UnitTestConfiguration = {
    return (OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Compute_UnitTestConfiguration (
      verbose = F,
      ...
      profile = OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Profile_P (
      ...
      genReplay = (c: Container, r: GumboXResult.Type) => Some(
        st"""val testVector = RTS.JSON.toActuationOrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_PreState_Container_P(json).left
            |assert (testComputeCBV(testVector) == results)""".render))
    )
  }
}

@record class OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Compute_UnitTestConfiguration (
  var verbose: B,
  var name: String,
  ...
  var profile: OrLogic_i_actuationSubsystem_actuationUnit1_tempPressureTripOut_orLogic_Profile_P_Trait,
