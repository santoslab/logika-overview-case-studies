...
object Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_UnitTestConfiguration_Util {
...
@record class Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Initialize_UnitTestConfiguration (
  var verbose: B,
  var name: String,
...
@record class Actuator_i_actuationSubsystem_saturationActuatorUnit_saturationActuator_actuator_Compute_UnitTestConfiguration (
  var verbose: B,
  var name: String,
  var description: String,
  var numTests: Z,
