...
object CoincidenceLogic_i_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_UnitTestConfiguration_Util {

  def freshRandomLib: RandomLib = {
    return RandomLib(Random.Gen64Impl(Xoshiro256.create))
  }

  def defaultComputeConfig: CoincidenceLogic_i_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_Compute_UnitTestConfiguration = {
    return (CoincidenceLogic_i_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_Compute_UnitTestConfiguration (
      verbose = F,
      ...
      profile = CoincidenceLogic_i_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_Profile_P (
      ...
      genReplay = (c: Container, r: GumboXResult.Type) => Some(
        st"""val testVector = RTS.JSON.toActuationCoincidenceLogic_i_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_PreState_Container_P(json).left
            |assert (testComputeCBV(testVector) == results)""".render))
    )
  }
}

@record class CoincidenceLogic_i_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_Compute_UnitTestConfiguration (
  var verbose: B,
  var name: String,
  ...
  override def test(c: Container): GumboXResult.Type = {
    return testComputeCBV(c.asInstanceOf[CoincidenceLogic_i_actuationSubsystem_actuationUnit2_temperatureLogic_coincidenceLogic_PreState_Container_P])
  }
}
